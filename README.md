...
<h2>Операции и методы</h2>
  • <b>Операции копирования, сравнения, обращения и перемещения:</b> Вектор реализует основные операции для управления элементами, включая копирование, сравнение, доступ по индексу и перемещение.
